...
apikey = '2587ec5f-61a7-47f8-ae08-8449372b862c'
secretkey = '5E7073240E7A9BDFD326E15C4F55A83E'
...
print (u' 现货历史交易信息 ')
info = okcoinSpot.trades('eth_cny')
print(info[0])
info = sorted(info, key=lambda x:x['tid'])
for x in info:
    print(x)
...
#print (u' 现货历史订单信息查询 ')
#print (okcoinSpot.orderHistory('btc_cny','1','0','200'))
